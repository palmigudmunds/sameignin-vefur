...
import logo from "../../resources/logo/logo-black-big.png";
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            {/* <p class="mt-4 max-w-xs text-gray-500">
              Stigagangurinn er nýtt fyrirtæki með það að markmiði að auðvelda
              fólki með rekstur húsfélagsins og sameina alla þjónustu við
              húsfélagið undir sama þak.
            </p> */}
            <p class="mt-4 max-w-xs text-gray-500">
              Sími:{" "}
